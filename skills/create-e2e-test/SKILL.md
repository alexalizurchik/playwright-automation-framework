...
description: Create Playwright JavaScript E2E tests from a user story in this automation framework. Use when the user asks Codex to generate positive and negative E2E scenarios, inspect a site from the configured baseURL, find or create the relevant Page Object class, collect locators, add methods, write or extend the matching .spec.js file, and validate the tests in a JS Playwright project.
---
